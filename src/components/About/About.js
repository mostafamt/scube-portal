        ...
        <div className="row align-items-center">
          <div className="col-lg-6 col-12">
            <div className="about-image-five">
              ...
              <img src="./static/images/graph.gif" alt="about" />
            </div>
          </div>
          <div className="col-lg-6 col-12">
                  ...
                  >
                    {/* <div className="list-style">
                      <div className="list-style-two">
                        <ul>
                          <li>
                            <i className="lni lni-check-box"></i>&nbsp;Education
                            must be inclusive and equitably accessible for all
                            learners especially those after-aged and those
                            vulnerable and underserved.
                          </li>
                          <li>
                            <i className="lni lni-check-box"></i>&nbsp;
                            <strong>
                              <u>Intelligent e-Learning</u>
                            </strong>
                            &nbsp;is the future of education and it is the
                            paradigm for LLL.
                          </li>
                          <li>
                            <i className="lni lni-check-box"></i>&nbsp;In The
                            Era of Intelligent e-Education everything is
                            changing and would become Virtual.
                          </li>
                        </ul>
                      </div>
                    </div> */}
                    ...
                    {/* <div className="list-style">
                      <div className="list-style-two">
                        <ul>
                          <li>
                            <i className="lni lni-check-box"></i>
                            &nbsp;Innovating a paradigm shift in e-Learning (
                            <strong>Adaptive Learning</strong>) with the target
                            of improving the Efficiency, Efficacy and Engagement
                            of LLL systems.
                          </li>
                          <li>
                            <i className="lni lni-check-box"></i>
                            &nbsp;Pioneering the technology of&nbsp;
                            <strong>Intelligent e-Learning</strong>
                            (NLP, ML, DL, IP, …).
                          </li>
                          <li>
                            <i className="lni lni-check-box"></i>
                            &nbsp;Establishing a new multidisciplinary field of
                            research "<strong>Intelligent e-Learning</strong>"
                          </li>
                        </ul>
                      </div>
                    </div> */}
